      ...
      {show && (
        ...
        >
          <motion.div
            ...
            className="flex w-[min(84vw,600px)] items-center justify-center"
          >
            <Image
              ...
              loading="eager"
              fetchPriority="high"
              sizes="(min-width: 768px) 600px, 84vw"
          ...
          <motion.span
            ...
            className="absolute bottom-10 left-1/2 -translate-x-1/2 text-[10px] uppercase tracking-[0.4em] text-ink/45"
          >
